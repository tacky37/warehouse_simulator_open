...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", help='config file name', default='small_warehouse03.json')
    ...
    parser.add_argument("--pa_size", help='pool_area_size', default=1) #　なしの場合は0
    parser.add_argument("--h_shift", help='hierarchical_shift', default=False) #ロボットも階層移動するか
    parser.add_argument("--batch", help='batch size(number)', default=None) #荷物をどの程度まとめて送るか
