...
def main(args):
    ...
    build_type = 'small_warehouse_e{}'.format(int(ELV[0]*ELV[1]))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--floorsize", help='The size of floor(x,y,z)', default=(50, 20, 9))
